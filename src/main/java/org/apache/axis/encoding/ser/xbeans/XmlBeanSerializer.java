        ...
        if (XmlObject.class.isAssignableFrom(javaType)) {
            ...
            if (schemaSrc.endsWith(".wsdl") || schemaSrc.endsWith(".WSDL")) {
                DefinitionsDocument defDoc =
                        (DefinitionsDocument)DefinitionsDocument.Factory.parse(stream);
                ...
                SchemaDocument schemaDoc = (SchemaDocument)SchemaDocument.Factory.parse(stream);
            ...
            */
            DefinitionsDocument defDoc = (DefinitionsDocument)DefinitionsDocument.Factory
                    .newInstance();
