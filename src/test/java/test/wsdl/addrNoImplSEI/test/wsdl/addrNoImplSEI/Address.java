...
public class Address  implements java.io.Serializable {
    ...
    private test.wsdl.addrNoImplSEI.StateType state;

    private int zip;

    private test.wsdl.addrNoImplSEI.Phone phone;
    ...
    public Address(
           ...
           test.wsdl.addrNoImplSEI.StateType state,
           int zip,
           test.wsdl.addrNoImplSEI.Phone phone) {
     ...
     * @return state
     */
    public test.wsdl.addrNoImplSEI.StateType getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(test.wsdl.addrNoImplSEI.StateType state) {
        this.state = state;
    }
     ...
     * @return phone
     */
    public test.wsdl.addrNoImplSEI.Phone getPhone() {
        return phone;
    }
     ...
     * @param phone
     */
    public void setPhone(test.wsdl.addrNoImplSEI.Phone phone) {
        this.phone = phone;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:AddrNoImplSEI", "Address"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:AddrNoImplSEI", "StateType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:AddrNoImplSEI", "Phone"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:AddrNoImplSEI", ">Phone"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
