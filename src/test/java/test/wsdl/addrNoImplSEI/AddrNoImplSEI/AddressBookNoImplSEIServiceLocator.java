...
public class AddressBookNoImplSEIServiceLocator extends org.apache.axis.client.Service implements AddrNoImplSEI.AddressBookNoImplSEIService {
    ...
    public AddrNoImplSEI.AddressBookNoImplSEI getAddressBookNoImplSEI() throws javax.xml.rpc.ServiceException {
    ...
    public AddrNoImplSEI.AddressBookNoImplSEI getAddressBookNoImplSEI(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            AddrNoImplSEI.AddressBookNoImplSEISoapBindingStub _stub = new AddrNoImplSEI.AddressBookNoImplSEISoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (AddrNoImplSEI.AddressBookNoImplSEI.class.isAssignableFrom(serviceEndpointInterface)) {
                AddrNoImplSEI.AddressBookNoImplSEISoapBindingStub _stub = new AddrNoImplSEI.AddressBookNoImplSEISoapBindingStub(new java.net.URL(AddressBookNoImplSEI_address), this);
                _stub.setPortName(getAddressBookNoImplSEIWSDDServiceName());
                return _stub;
            }
        }
