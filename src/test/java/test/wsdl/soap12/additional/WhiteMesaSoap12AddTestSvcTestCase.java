...
//    public static final String HOST = "http://localhost:8080";
    ...
    public static String RPC_ENDPOINT = HOST + "/test/add-test-rpc";
    public static String DOC_ENDPOINT = HOST + "/test/add-test-doc";
    public static String GET_DOC_ENDPOINT = HOST + "/test/add-test-doc/getTime";
    public static String GET_RPC_ENDPOINT = HOST + "/test/add-test-rpc/getTime";
    public static String DOC_INT_ENDPOINT = HOST + "/test/add-test-doc-int";
    public static String DOC_INT_UC_ENDPOINT = HOST + "/test/add-test-doc-int-uc";
...
//        junit.textui.TestRunner.run(WhiteMesaSoap12AddTestSvcTestCase.class);
    ...
    protected void setUp() throws Exception {
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            if ("host".equals(tag)) {
                HOST = data;
                RPC_ENDPOINT = HOST + "/test/add-test-rpc";
                DOC_ENDPOINT = HOST + "/test/add-test-doc";
                GET_DOC_ENDPOINT = HOST + "/test/add-test-doc/getTime";
                GET_RPC_ENDPOINT = HOST + "/test/add-test-rpc/getTime";
                DOC_INT_ENDPOINT = HOST + "/test/add-test-doc-int";
                DOC_INT_UC_ENDPOINT = HOST + "/test/add-test-doc-int-uc";
