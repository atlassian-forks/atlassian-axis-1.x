...
public class Phone  implements java.io.Serializable {
    ...
    private test.wsdl.dataobjects.refattr.PhoneNumber number;
    ...
    public Phone(
           ...
           test.wsdl.dataobjects.refattr.PhoneNumber number) {
     ...
     * @return number
     */
    public test.wsdl.dataobjects.refattr.PhoneNumber getNumber() {
        return number;
    }
     ...
     * @param number
     */
    public void setNumber(test.wsdl.dataobjects.refattr.PhoneNumber number) {
        this.number = number;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:ref.types", "phone"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:ref.types", ">phone>number"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
