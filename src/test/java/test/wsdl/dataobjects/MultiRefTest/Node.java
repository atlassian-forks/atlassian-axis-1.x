...
public class Node  extends test.wsdl.dataobjects.MultiRefTest.Nodebase  implements java.io.Serializable {
    private int data;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:MultiRefTest2", "node"));
