...
public class AttachmentsBindingStub extends org.apache.axis.client.Stub implements test.wsdl.dataobjects.dime-rpc.AttachmentsPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "In"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "base64Binary"), byte[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://xml.apache.org/xml-soap", "octet-stream"));
        oper.setReturnClass(org.apache.axis.attachments.OctetStream.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "Out"));
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "In"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://xml.apache.org/xml-soap", "PlainText"), java.lang.String.class, false, false);
        oper.addParameter(param);
    ...
    public AttachmentsBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("http://soapinterop.org/attachments/xsd", "ArrayOfBinary");
            cachedSerQNames.add(qName);
            cls = test.wsdl.dataobjects.dime-rpc.ReferencedBinary[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = test.wsdl.dataobjects.dime-rpc.ReferencedText.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            cachedDeserFactories.add(org.apache.axis.encoding.ser.BaseDeserializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleDeserializerFactory.class, cls, qName));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                ...
                return (org.apache.axis.attachments.OctetStream) org.apache.axis.utils.JavaUtils.convert(_resp, test.wsdl.dataobjects.dime-rpc.ReferencedBinary.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public org.apache.axis.attachments.OctetStream[] echoAttachments(org.apache.axis.attachments.OctetStream[] in) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://soapinterop.org/attachments/", "EchoAttachments"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in});
  ...
  throw axisFaultException;
    ...
    public byte[] echoAttachmentAsBase64(org.apache.axis.attachments.OctetStream in) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://soapinterop.org/attachments/", "EchoAttachmentAsBase64"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in});
  ...
  throw axisFaultException;
    ...
    public org.apache.axis.attachments.OctetStream echoBase64AsAttachment(byte[] in) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://soapinterop.org/attachments/");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://soapinterop.org/attachments/", "EchoBase64AsAttachment"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in});
  ...
  throw axisFaultException;
    ...
    public void echoUnrefAttachments() throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://soapinterop.org/attachments/");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://soapinterop.org/attachments/", "EchoUnrefAttachments"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public java.lang.String echoAttachmentAsString(java.lang.String in) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://soapinterop.org/attachments/", "EchoAttachmentAsString"));
