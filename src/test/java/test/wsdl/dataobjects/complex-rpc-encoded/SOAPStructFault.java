...
public class SOAPStructFault  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    private test.wsdl.dataobjects.complex-rpc-encoded.SOAPStruct soapStruct;

    public SOAPStructFault() {
    }

    public SOAPStructFault(
           test.wsdl.dataobjects.complex-rpc-encoded.SOAPStruct soapStruct) {
     ...
     * @return soapStruct
     */
    public test.wsdl.dataobjects.complex-rpc-encoded.SOAPStruct getSoapStruct() {
        return soapStruct;
    }
     ...
     * @param soapStruct
     */
    public void setSoapStruct(test.wsdl.dataobjects.complex-rpc-encoded.SOAPStruct soapStruct) {
        this.soapStruct = soapStruct;
    }
