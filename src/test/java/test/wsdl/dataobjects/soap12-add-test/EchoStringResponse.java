...
public class EchoStringResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this EchoStringResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this EchoStringResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soapinterop.org/", ">echoStringResponse"));
