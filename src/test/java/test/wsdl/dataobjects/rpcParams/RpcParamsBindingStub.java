...
public class RpcParamsBindingStub extends org.apache.axis.client.Stub implements test.wsdl.dataobjects.rpcParams.RpcParamsTest {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:rpcParams.wsdl.test", "EchoStruct"));
        oper.setReturnClass(test.wsdl.dataobjects.rpcParams.EchoStruct.class);
    ...
    public RpcParamsBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("urn:rpcParams.wsdl.test", "EchoStruct");
            cachedSerQNames.add(qName);
            cls = test.wsdl.dataobjects.rpcParams.EchoStruct.class;
    ...
    public test.wsdl.dataobjects.rpcParams.EchoStruct echo(java.lang.String first, java.lang.String second) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:rpcParams.wsdl.test", "echo"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {first, second});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (test.wsdl.dataobjects.rpcParams.EchoStruct) _resp;
            } catch (java.lang.Exception _exception) {
                return (test.wsdl.dataobjects.rpcParams.EchoStruct) org.apache.axis.utils.JavaUtils.convert(_resp, test.wsdl.dataobjects.rpcParams.EchoStruct.class);
            }
        }
