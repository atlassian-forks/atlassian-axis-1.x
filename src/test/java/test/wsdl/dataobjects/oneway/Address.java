...
public class Address  implements java.io.Serializable {
    ...
    private test.wsdl.dataobjects.oneway.StateType state;

    private int zip;

    private test.wsdl.dataobjects.oneway.Phone phoneNumber;
    ...
    public Address(
           ...
           test.wsdl.dataobjects.oneway.StateType state,
           int zip,
           test.wsdl.dataobjects.oneway.Phone phoneNumber) {
     ...
     * @return state
     */
    public test.wsdl.dataobjects.oneway.StateType getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(test.wsdl.dataobjects.oneway.StateType state) {
        this.state = state;
    }
     ...
     * @return phoneNumber
     */
    public test.wsdl.dataobjects.oneway.Phone getPhoneNumber() {
        return phoneNumber;
    }
     ...
     * @param phoneNumber
     */
    public void setPhoneNumber(test.wsdl.dataobjects.oneway.Phone phoneNumber) {
        this.phoneNumber = phoneNumber;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oneway.wsdl.test", "address"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:oneway.wsdl.test", "stateType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:oneway.wsdl.test", "phone"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
