...
public class AdaptiveServiceLocator extends org.apache.axis.client.Service implements test.wsdl.dataobjects.adaptive.AdaptiveService {
    ...
    public test.wsdl.dataobjects.adaptive.AdaptiveInterface getAdaptive(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.wsdl.dataobjects.adaptive.AdaptiveInterfaceBindingStub _stub = new test.wsdl.dataobjects.adaptive.AdaptiveInterfaceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.wsdl.dataobjects.adaptive.AdaptiveInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                test.wsdl.dataobjects.adaptive.AdaptiveInterfaceBindingStub _stub = new test.wsdl.dataobjects.adaptive.AdaptiveInterfaceBindingStub(new java.net.URL(Adaptive_address), this);
                _stub.setPortName(getAdaptiveWSDDServiceName());
                return _stub;
            }
        }
