...
public class ImmediateChargeResponse  extends test.wsdl.dataobjects.good.CSCommonResponse  implements java.io.Serializable {
    private test.wsdl.dataobjects.good.CSQualifiedAmount chargedAmount;

    public ImmediateChargeResponse() {
    }
    ...
    /**
     * Gets the chargedAmount value for this ImmediateChargeResponse.
     * 
    ...
    /**
     * Sets the chargedAmount value for this ImmediateChargeResponse.
     * 
     * @param chargedAmount
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImmediateChargeResponse)) return false;
        ImmediateChargeResponse other = (ImmediateChargeResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImmediateChargeResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:CPWSImpl", "immediateChargeResponse"));
