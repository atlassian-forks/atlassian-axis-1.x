...
public class BaseStruct  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    private test.wsdl.dataobjects.complex-doc-literal.SOAPStruct structMessage;
    ...
    /**
     * Gets the structMessage value for this BaseStruct.
     * 
     * @return structMessage
     */
    public test.wsdl.dataobjects.complex-doc-literal.SOAPStruct getStructMessage() {
        return structMessage;
    }


    /**
     * Sets the structMessage value for this BaseStruct.
     * 
     * @param structMessage
     */
    public void setStructMessage(test.wsdl.dataobjects.complex-doc-literal.SOAPStruct structMessage) {
        this.structMessage = structMessage;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.structMessage==null && other.getStructMessage()==null) || 
             (this.structMessage!=null &&
              this.structMessage.equals(other.getStructMessage()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getStructMessage() != null) {
            _hashCode += getStructMessage().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("structMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("", "structMessage"));
