...
public class String  implements java.io.Serializable {
    ...
    /**
     * Gets the test value for this String.
     * 
     * @return test
     */
    ...
    /**
     * Sets the test value for this String.
     * 
     * @param test
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:comprehensive-types.types.wsdl.test", "String"));
