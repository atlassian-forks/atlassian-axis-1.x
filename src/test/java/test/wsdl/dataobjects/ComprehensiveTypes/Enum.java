...
public class Enum implements java.io.Serializable {
    ...
    public static final Enum one = new Enum(_one);
    public static final Enum two = new Enum(_two);
    public static final Enum three = new Enum(_three);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:comprehensive-types.types.wsdl.test", "enum"));
    }
    /**
