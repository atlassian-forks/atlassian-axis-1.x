...
public class EnumInt implements java.io.Serializable {
    private int _value_;
    ...
    public static final EnumInt value3 = new EnumInt(_value3);
    public int getValue() { return _value_;}
    public static EnumInt fromValue(int value)
          throws java.lang.IllegalArgumentException {
        EnumInt enumeration = (EnumInt)
            _table_.get(new java.lang.Integer(value));
        if (enumeration==null) throw new java.lang.IllegalArgumentException();
        return enumeration;
    }
    public static EnumInt fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        try {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EnumInt.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:comprehensive-types.types.wsdl.test", "enumInt"));
    }
    /**
