...
public class _class  implements java.io.Serializable {
    ...
    /**
     * Gets the test value for this _class.
     * 
     * @return test
     */
    ...
    /**
     * Sets the test value for this _class.
     * 
     * @param test
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _class)) return false;
        _class other = (_class) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_class.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:comprehensive-types.types.wsdl.test", "Class"));
