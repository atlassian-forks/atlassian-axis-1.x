...
public class ExtensionSettings  implements java.io.Serializable {
    ...
    private test.wsdl.dataobjects.reportservice.ArrayOfChoice1 parameterValues;
    ...
    public ExtensionSettings(
           ...
           test.wsdl.dataobjects.reportservice.ArrayOfChoice1 parameterValues) {
     ...
     */
    public test.wsdl.dataobjects.reportservice.ArrayOfChoice1 getParameterValues() {
        return parameterValues;
    }
     ...
     */
    public void setParameterValues(test.wsdl.dataobjects.reportservice.ArrayOfChoice1 parameterValues) {
        this.parameterValues = parameterValues;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2003/12/reporting/reportingservices", "ExtensionSettings"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2003/12/reporting/reportingservices", "ParameterValues"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2003/12/reporting/reportingservices", "ArrayOfChoice1"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
