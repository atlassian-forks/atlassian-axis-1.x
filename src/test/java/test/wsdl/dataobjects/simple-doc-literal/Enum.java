...
public class Enum implements java.io.Serializable {
    ...
    public static final Enum value1 = new Enum(_value1);
    public static final Enum value2 = new Enum(_value2);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soapinterop.org/types", "Enum"));
    }
    /**
