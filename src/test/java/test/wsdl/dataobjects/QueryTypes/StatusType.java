...
public class StatusType implements java.io.Serializable {
    ...
    public static final StatusType MORE = new StatusType(_MORE);
    public static final StatusType LESS = new StatusType(_LESS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:QueryTypes", "StatusType"));
    }
    /**
