...
public class SOAPStructStruct  implements java.io.Serializable {
    ...
    private test.wsdl.dataobjects.soap12-test.SOAPStruct varStruct;
    ...
    public SOAPStructStruct(
           ...
           int varInt,
           float varFloat,
           test.wsdl.dataobjects.soap12-test.SOAPStruct varStruct) {
     ...
     * @return varStruct
     */
    public test.wsdl.dataobjects.soap12-test.SOAPStruct getVarStruct() {
        return varStruct;
    }
     ...
     * @param varStruct
     */
    public void setVarStruct(test.wsdl.dataobjects.soap12-test.SOAPStruct varStruct) {
        this.varStruct = varStruct;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://example.org/ts-tests/xsd", "SOAPStructStruct"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://example.org/ts-tests/xsd", "SOAPStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
