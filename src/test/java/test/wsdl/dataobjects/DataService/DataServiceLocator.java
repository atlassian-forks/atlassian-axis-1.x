...
public class DataServiceLocator extends org.apache.axis.client.Service implements test.wsdl.dataobjects.DataService.DataService {
    ...
    private java.lang.String DataServiceSoap_address = "http://samples.gotdotnet.com/quickstart/aspplus/samples/services/DataService/VB/DataService.asmx";
    ...
    public test.wsdl.dataobjects.DataService.DataServiceSoap_PortType getDataServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.wsdl.dataobjects.DataService.DataServiceSoap_BindingStub _stub = new test.wsdl.dataobjects.DataService.DataServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.wsdl.dataobjects.DataService.DataServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                test.wsdl.dataobjects.DataService.DataServiceSoap_BindingStub _stub = new test.wsdl.dataobjects.DataService.DataServiceSoap_BindingStub(new java.net.URL(DataServiceSoap_address), this);
                _stub.setPortName(getDataServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tempuri.org/", "DataService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tempuri.org/", "DataServiceSoap"));
        }
