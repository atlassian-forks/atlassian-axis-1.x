...
public class SoapBindingStub extends org.apache.axis.client.Stub implements test.wsdl.dataobjects.any.Soap_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(test.wsdl.dataobjects.any.QueryResult.class);
    ...
    public SoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cls = test.wsdl.dataobjects.any.Query.class;
            ...
            cachedSerQNames.add(qName);
            cls = test.wsdl.dataobjects.any.QueryResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = test.wsdl.dataobjects.any.QueryResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = test.wsdl.dataobjects.any.SObject.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public test.wsdl.dataobjects.any.QueryResult query(java.lang.String queryString) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {queryString});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (test.wsdl.dataobjects.any.QueryResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (test.wsdl.dataobjects.any.QueryResult) org.apache.axis.utils.JavaUtils.convert(_resp, test.wsdl.dataobjects.any.QueryResult.class);
            }
        }
