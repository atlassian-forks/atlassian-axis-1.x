...
public class AnyServiceLocator extends org.apache.axis.client.Service implements test.wsdl.dataobjects.any.AnyService {

    public AnyServiceLocator() {
    }


    public AnyServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public AnyServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for Soap
    private java.lang.String Soap_address = "http://localhost:8080/axis/services/Soap";
    ...
    public test.wsdl.dataobjects.any.Soap_PortType getSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.wsdl.dataobjects.any.SoapBindingStub _stub = new test.wsdl.dataobjects.any.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.wsdl.dataobjects.any.Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                test.wsdl.dataobjects.any.SoapBindingStub _stub = new test.wsdl.dataobjects.any.SoapBindingStub(new java.net.URL(Soap_address), this);
                _stub.setPortName(getSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "AnyService");
    }
