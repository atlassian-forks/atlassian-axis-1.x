...
public class QueryResult  implements java.io.Serializable {
    ...
    private test.wsdl.dataobjects.any.SObject[] records;
    ...
    public QueryResult(
           ...
           test.wsdl.dataobjects.any.SObject[] records,
           int size) {
           this.done = done;
     ...
     * @return records
     */
    public test.wsdl.dataobjects.any.SObject[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(test.wsdl.dataobjects.any.SObject[] records) {
        this.records = records;
    }

    public test.wsdl.dataobjects.any.SObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, test.wsdl.dataobjects.any.SObject _value) {
