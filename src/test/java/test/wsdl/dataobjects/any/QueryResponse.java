...
public class QueryResponse  implements java.io.Serializable {
    private test.wsdl.dataobjects.any.QueryResult result;

    public QueryResponse() {
    }

    public QueryResponse(
           test.wsdl.dataobjects.any.QueryResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public test.wsdl.dataobjects.any.QueryResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(test.wsdl.dataobjects.any.QueryResult result) {
        this.result = result;
    }
