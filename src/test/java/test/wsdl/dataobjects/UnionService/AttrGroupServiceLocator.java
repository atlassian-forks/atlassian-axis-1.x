...
public class AttrGroupServiceLocator extends org.apache.axis.client.Service implements test.wsdl.dataobjects.UnionService.AttrGroupService {
    ...
    public test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_PortType getAttrGroupServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_PortType getAttrGroupServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_BindingStub _stub = new test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_BindingStub _stub = new test.wsdl.dataobjects.UnionService.AttrGroupServiceSoap_BindingStub(new java.net.URL(AttrGroupServiceSoap_address), this);
                _stub.setPortName(getAttrGroupServiceSoapWSDDServiceName());
                return _stub;
            }
        }
