    ...
    public void testStep3EchoStruct() {
        ...
        try {
            if (url != null) {
                ...
                String serviceUrl = "http://localhost:" + simpleAxisPort + "/axis/services/SoapInteropImport3Port";
                binding = new Import3Locator().getSoapInteropImport3Port(new java.net.URL(serviceUrl));
            }
        }
